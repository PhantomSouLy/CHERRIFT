(() => {
  ...
  function ensureCss() {
    ...
    style.textContent = `
      ...
      .bf-card{border:1px solid var(--theme-outline-soft,#ffffff22);border-radius:25px;background:var(--theme-surface,linear-gradient(145deg,#2a102fdd,#100715ed));box-shadow:0 20px 70px var(--theme-shadow,#0005)}.bf-button{min-height:52px;padding:0 18px;border:0;border-radius:15px;color:#fff;background:var(--theme-button,linear-gradient(115deg,#d52f7d,#ec70aa));font-weight:1000}.bf-button:disabled{opacity:.42}.bf-button.secondary{border:1px solid var(--theme-outline-soft,#ffffff25);color:var(--theme-text,#fff);background:var(--theme-surface-2,#ffffff08)}.bf-button.danger{border:1px solid #c95e7355;background:linear-gradient(115deg,#9d4058,#c95e73)}
      .mail-toolbar-bf{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:17px 20px;border-bottom:1px solid var(--theme-outline-soft,#ffffff18)}.mail-toolbar-bf h3{margin:0;color:var(--theme-text,#fff);font:700 30px Georgia,serif}.mail-toolbar-bf small{color:var(--theme-muted,#c7aebd)}.mail-list-bf{display:grid;max-height:min(58dvh,650px);min-height:320px;overflow-y:auto;overscroll-behavior:contain}.mail-row-bf{width:100%;min-height:82px;display:grid;grid-template-columns:34px minmax(0,1fr);align-items:center;gap:10px;padding:0 18px;border-bottom:1px solid var(--theme-outline-soft,#ffffff12);color:var(--theme-text,#fff);background:transparent}.mail-row-open-bf{width:100%;min-height:81px;display:grid;grid-template-columns:10px minmax(0,1fr) auto;align-items:center;gap:13px;padding:11px 0;border:0;color:inherit;background:transparent;text-align:left}.mail-row-bf:hover{background:color-mix(in srgb,var(--theme-primary,#dc3c86) 7%,transparent)}.mail-row-bf.unread{background:linear-gradient(90deg,color-mix(in srgb,var(--theme-primary,#dc3c86) 10%,transparent),transparent)}.mail-select-bf{width:19px;height:19px;accent-color:var(--theme-primary,#ec5ba4)}.mail-dot-bf{width:8px;height:8px;border-radius:50%;background:transparent}.mail-row-bf.unread .mail-dot-bf{background:var(--theme-primary,#f05aa5);box-shadow:0 0 12px color-mix(in srgb,var(--theme-primary,#f05aa5) 60%,transparent)}.mail-row-bf b,.mail-row-bf small{display:block}.mail-row-bf small{margin-top:4px;color:var(--theme-muted,#c7aebd)}.mail-reward-mark-bf{color:var(--theme-primary,#ff9acb);font-size:20px}.mail-empty-bf{padding:50px 20px;text-align:center;color:var(--theme-muted,#c7aebd)}.mail-list-actions-bf{position:sticky;bottom:0;z-index:4;display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:9px;padding:12px;border-top:1px solid var(--theme-outline-soft,#ffffff18);background:color-mix(in srgb,var(--theme-surface,#130919) 96%,transparent);backdrop-filter:blur(10px)}.mail-list-actions-bf .bf-button{min-height:46px;padding:0 8px}.mail-detail-bf{padding:4px}.mail-detail-bf header{padding:0 52px 16px 0;border-bottom:1px solid var(--theme-outline-soft,#ffffff18)}.mail-detail-bf header small{color:var(--theme-muted,#c9aebe);font-weight:800}.mail-detail-bf h3{margin:7px 0 0;color:var(--theme-text,#fff);font:700 clamp(28px,7vw,44px) Georgia,serif}.mail-body-bf{min-height:130px;padding:22px 2px;color:var(--theme-text,#fff);white-space:pre-wrap;line-height:1.65}.mail-reward-bf{display:grid;gap:7px;padding:15px;border:1px solid color-mix(in srgb,var(--theme-primary,#ff9bc8) 42%,transparent);border-radius:17px;background:color-mix(in srgb,var(--theme-primary,#e24487) 8%,transparent)}.mail-reward-bf b{color:var(--theme-primary-strong,var(--theme-primary,#ff9bc8))}.mail-reward-bf p{margin:0;color:var(--theme-text,#fff)}.mail-actions-bf{display:grid;grid-template-columns:.8fr 1fr 1fr;gap:10px;margin-top:18px}
      .bf-modal{position:fixed;inset:0;z-index:100100;display:grid;place-items:center;padding:17px;background:#07030cbf;backdrop-filter:blur(9px)}.bf-modal.hidden{display:none!important}.bf-modal-card{position:relative;width:min(620px,100%);max-height:90dvh;overflow:auto;padding:24px;border:1px solid var(--theme-outline,#ffffff28);border-radius:27px;color:var(--theme-text,#fff);background:var(--theme-surface,linear-gradient(150deg,#32123bea,#100716));box-shadow:0 28px 90px var(--theme-shadow-strong,#0009)}.mail-detail-card-v098{width:min(680px,96vw)}.bf-modal-card h3{margin:0 44px 8px 0;font:700 34px Georgia,serif}.bf-x{position:absolute;right:15px;top:15px;width:42px;height:42px;border:1px solid var(--theme-outline-soft,#ffffff22);border-radius:13px;color:var(--theme-text,#fff);background:var(--theme-surface-2,#ffffff08);font-size:20px}.bf-form{display:grid;gap:12px;margin-top:18px}.bf-form input{width:100%;min-height:55px;padding:0 15px;border:1px solid var(--theme-outline-soft,#ffffff28);border-radius:15px;color:var(--theme-text,#fff);background:var(--theme-surface-2,#09040dc7);font-size:17px;outline:none}.bf-form-actions{display:grid;grid-template-columns:1fr 1fr;gap:10px}.bf-status{min-height:20px;margin:0;color:var(--theme-primary,#f2afd0)}
      ...
      @media(max-width:820px){.bf-shell{padding:12px 12px 120px}.bf-head h2{font-size:48px}.bf-back{width:64px;height:64px}.mail-toolbar-bf{padding:14px}.mail-toolbar-bf h3{font-size:27px}.mail-row-bf{grid-template-columns:28px minmax(0,1fr);padding:0 12px}.mail-list-actions-bf{gap:6px;padding:9px}.mail-list-actions-bf .bf-button{min-height:42px;padding:0 5px;font-size:10px}.profile-hero-bf{grid-template-columns:96px minmax(0,1fr);gap:15px;padding:18px}.profile-avatar-bf{width:96px;height:96px;border-radius:23px}.profile-title-stats-button-bf{min-height:38px;font-size:10px}.profile-stat-bf{min-height:105px}.profile-stat-bf b{font-size:37px}.bf-form-actions{grid-template-columns:1fr}.mail-actions-bf{grid-template-columns:.75fr 1fr 1fr}}
  ...
  function ensureMailDetailModal(){
    ...
    modal=document.createElement("section");modal.id="mailDetailModalV096";modal.className="bf-modal mail-detail-modal-v098 hidden";
    modal.innerHTML='<div class="bf-modal-card mail-detail-card-v098"><button type="button" class="bf-x" data-mail-detail-close>×</button><div id="mailDetailModalBody"></div></div>';
